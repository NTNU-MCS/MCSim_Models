...
Par.Wave.omega_peak(1)	= 0.9;%0.53;%.43;  %0.75;  %0.8;  % 0.5;  %.75;   % saet peak frequency very low when no waves     	% Peak frequency component in sea state, 0 for expectation value based on Hs
for i=2:25
...
Par.Current.wn_t_vel 	= Ts;			% Velocity white noise sample time
...
Par.Current.wn_t_dir 	= Ts;			% Direction white noise sample time
